...
type Landtitle struct {
	gorm.Model
	SurveyNumber string `json:"survey_number" gorm:"type:varchar(50);default:''"` // ระวาง เช่น "5336 IV 8632"
	LandNumber   string `json:"land_number" gorm:"type:varchar(20);not null;default:''"`  // เลขที่ดิน เช่น "๑๑"
	SurveyPage   string `json:"survey_page" gorm:"type:varchar(20);not null;default:''"`   // หน้าสำรวจ เช่น "๙๔๖๑"
	Tambo_n   string `json:"tambon" gorm:"type:varchar(100);not null;default:''"`   // ตำบล
	...
	// ข้อมูลโฉนด
	TitleDeedNumber string `json:"title_deed_number" gorm:"type:varchar(50);not null;default:''"` // เลขที่โฉนด
	Volume          string `json:"volume" gorm:"type:varchar(20);not null;default:''"`           // เล่ม
	Page            string `json:"page" gorm:"type:varchar(20);not null;default:''"`             // หน้า
	Amphoe   string `json:"amphoe" gorm:"type:varchar(100);not null;default:''"`  // อำเภอ
	Provinc_e string `json:"province" gorm:"type:varchar(100);not nul;default:''"` // จังหวัด
