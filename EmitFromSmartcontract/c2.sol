...
contract LandTitleNFT is ERC721 {
    ...
    function setSaleInfo(
        ...
        bytes32 messageHash = keccak256(
            abi.encodePacked(tokenId, price, buyer)
        );
        bytes32 ethHash = _toEthSignedMessageHash(messageHash);
        address signer = ECDSA.recover(ethHash, signature);
...
function buyLandTitle(uint256 tokenId) external payable {
    ...
    function tokenURI(
        ...
        string
            memory imageUrl = "https://amethyst-giant-warbler-920.mypinata.cloud/ipfs/bafybeigoemqyh7dvkhlxt6zwy4jnpkcfvmoci6ymwkliblvcovvnuxnbyy";
