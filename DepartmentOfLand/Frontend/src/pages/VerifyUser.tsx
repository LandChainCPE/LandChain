import { CheckCircle, User, Shield, FileText, Clock, AlertCircle, Building2, X, Wallet, Copy, Check } from "lucide-react";
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">กรมที่ดิน</h1>
                <p className="text-blue-100 text-sm">Digital Land Department</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <div className="bg-green-500 bg-opacity-20 text-green-100 px-4 py-2 rounded-full border border-green-300 border-opacity-30">
                <div className="flex items-center space-x-2">
                  <Shield className="w-4 h-4" />
                  <span className="text-sm font-medium">Secure System</span>
                </div>
              </div>
              <div className="bg-white bg-opacity-10 text-white px-4 py-2 rounded-full border border-white border-opacity-20">
                <span className="text-sm font-medium">ID: #{bookingID}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-r from-slate-50 to-blue-50 px-8 py-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 text-lg">Digital Identity Verification System</p>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100">
                  ...
                  <div className="space-y-4">
                    ...
                    <button className="w-full bg-white border-2 border-red-300 hover:border-red-400 hover:bg-red-50 text-red-700 font-semibold py-4 px-6 rounded-xl transition-all duration-200 shadow-md hover:shadow-lg">
