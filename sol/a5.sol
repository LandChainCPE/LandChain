...
contract DigitalLandTitle is ERC721Pausable, Ownable {
    ...
    mapping(bytes32 => bool) public usedNameHash; // ป้องกัน nameHash ซ้ำ
    ...
    /// @notice ลงทะเบียนเจ้าของใหม่ ต้องแนบ signature จากระบบ และป้องกัน nameHash ซ้ำ
    ...
    /// @notice ดูข้อมูลเจ้าของที่ลงทะเบียน
